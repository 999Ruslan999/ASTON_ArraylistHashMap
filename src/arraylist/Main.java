...
public class Main {
    public static void main(String[] args) {
        ...
        // Создал 5 методов:
        // 1) Добавление новой заметки. (По заданию добавление)
        // 2) Удаление заметки по её индексу. (По заданию удаление)
        // 3) Редактирование элемента по индексу. (По заданию редактирование)
        // 4) Вывод элемента по индексу. (По заданию, возможность вывести элемент по индексу)
